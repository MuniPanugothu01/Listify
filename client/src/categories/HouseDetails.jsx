...
function HouseDetails() {
  ...
  useEffect(() => {
    try {
      ...
      setError("Failed to load house data", err);
      setLoading(false);
    }
  }, [id]);
  ...
  const extractFeatures = (description) => {
    ...
    if (
      description.toLowerCase().includes("garden") ||
      description.toLowerCase().includes("yard")
    )
    ...
    if (
      description.toLowerCase().includes("air conditioning") ||
  ...
  const getSimilarProperties = () => {
    if (!house) return [];
    return data.houses.filter((h) => h.id !== house.id).slice(0, 6);
  };
  ...
  const displayImages = [
    ...
    "https://images.unsplash.com/photo-1627378056601-7f5a50011383?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=687",
  ];
  return (
          ...
          <div className="lg:w-2/3">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 border-b border-gray-200">
                ...
                {/* Enhanced Property Stats - Like Screenshot Style */}
                  ...
                  <div className="grid lg:grid-cols-9 md:grid-cols-3 grid-cols-2   text-center">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-2 border border-gray-200">
                        <Bed className="w-6 h-6 text-[#2F3A63]" />
                      </div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-2 border border-gray-200">
                        <Bath className="w-6 h-6 text-[#2F3A63]" />
                      </div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-2 border border-gray-200">
                        <Square className="w-6 h-6 text-[#2F3A63]" />
                      </div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-2 border border-gray-200">
                        <Car className="w-6 h-6 text-[#2F3A63]" />
                      </div>
                    ...
                    <div className="flex flex-col items-center col-span-2 md:col-span-1 mt-4 md:mt-0">
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-2 border border-gray-200">
                        <Shield className="w-6 h-6 text-[#2F3A63]" />
                      </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 p-4 bg-blue-50 rounded-lg">
                  <div className="text-center">
                    <Building className="w-5 h-5 text-[#2F3A63] mx-auto mb-1" />
                  ...
                  <div className="text-center">
                    <Ruler className="w-5 h-5 text-[#2F3A63] mx-auto mb-1" />
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            ...
                            <span className="font-medium text-[#2F3A63]">
                              {house.type === "rent"
                                ? `$${house.price}/month`
                                : `$${house.price.toLocaleString()}`}
                            </span>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                  <Home className="w-5 h-5 text-[#2F3A63]" />
              ...
              <div className="divide-y divide-gray-100 max-h-[600px] overflow-y-auto">
                {similarProperties.map((similarHouse) => (
                  <Link
                    key={similarHouse.id}
                    to={`/categories/houses/${similarHouse.id}`}
