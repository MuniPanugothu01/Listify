...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full bg-transparent flex flex-col-reverse lg:flex-row items-center justify-between px-4 sm:px-8 md:px-12 lg:px-16 lg:pt-16 pb-12 lg:pb-20 lg:min-h-[600px] min-h-[560px] z-10">
      ...
      {/* RIGHT SIDE - GLOBE */}
      <div className="w-full lg:w-1/2 flex justify-center lg:justify-end items-center z-10">
        <Globe className="w-[300px] md:mt-10 sm:w-[380px] md:w-[380px] lg:w-[460px] xl:w-[520px] max-w-full h-auto object-contain lg:mr-20" />
      </div>
    </section>
  );
};
