...
export default function MarketplaceDiscovery() {
  ...
  const categories = [
    ...
    {
      imageUrl: "https://images.unsplash.com/photo-1593642532973-d31b6557fa68?w=400&h=300&fit=crop",
    ...
    {
      imageUrl: "https://images.unsplash.com/photo-1603791440384-56cd371ee9a7?w=400&h=300&fit=crop",
      label: "Resumes",
          ...
          <div className="w-full lg:w-96 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-6 transform hover:-translate-y-1 transition-all duration-300 border border-gray-200/50 relative">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-[#2F3A63]/5 to-blue-500/5 rounded-xl border border-[#2F3A63]/10">
              <p className="text-sm text-gray-600 text-center">
                📅 <strong>{selectedDates.length} dates selected</strong> • Local events and marketplace highlights
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Explore {categories.reduce((sum, cat) => sum + cat.stats.active, 0).toLocaleString()}+ verified listings across your community
                </p>
              </div>
