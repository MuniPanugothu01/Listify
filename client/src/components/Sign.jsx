...
const Sign = () => {
  ...
  const handleSignIn = (e) => {
    ...
    if (user) {
      // User exists and credentials match - log them in
      ...
      // Show toast and navigate after delay to allow toast to display
  ...
  const handleSignUp = (e) => {
    ...
    // Show success toast and switch to sign-in after toast closes
  ...
  return (
    <>
      ...
      {/* Toast Container - Placed outside the flex container to avoid layout interference */}
      <ToastContainer
        position="top-right"
        autoClose={2000}
        ...
        pauseOnHover
        theme="light"
        limit={1} // Optional: Limit to one toast at a time
        style={{ zIndex: 9999 }} // Ensure high z-index for overlay
      />
    </>
  );
};
