...
const PersonalDetailsSection = ({ user, isEditing, setIsEditing, editData, setEditData, profilePicPreview, handleProfilePicChange, handleSave, handleCancel }) => (
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pb-6 border-b border-gray-100">
          <div className="relative flex-shrink-0">
            <img 
              ...
              alt="Profile Preview" 
              className="w-24 h-24 rounded-full object-cover border-4 border-[#A9E4FB]/20" 
            />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          {isEditing ? (
            ...
            <div className="px-4 py-3 bg-gray-50 rounded-xl text-gray-900 font-medium">{editData.name}</div>
          )}
        </div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <div className="px-4 py-3 bg-gray-50 rounded-xl text-gray-900">{editData.email}</div>
          )}
        </div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <div className="px-4 py-3 bg-gray-50 rounded-xl text-gray-900">{editData.phone}</div>
          )}
        </div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <div className="px-4 py-3 bg-gray-50 rounded-xl text-gray-900">{editData.address}</div>
          )}
        </div>
      </div>
