      ...
      <div className="min-h-screen bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-16 bg-white rounded-lg shadow-md">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">No Saved Items</h2>
            <p className="text-gray-600 mb-8">Start saving properties you love to see them here!</p>
            <Link 
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-6">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Saved Items ({savedItems.length})</h1>
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  <a
                    href={`mailto:${getContactEmail(item)}?subject=Inquiry about ${item.title}`}
